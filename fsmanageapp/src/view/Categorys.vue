                    ...
                    <v-card-text>
                        ...
                        <v-row>
                            <v-col cols="12" class="text-right">
                                <v-btn class="gray" v-if="this.action != 1" @click="updateCategory">EDIT</v-btn>
                                <v-btn class="gray" @click="createCategory" v-else>ADD</v-btn>
                            </v-col>
                        </v-row>
                    </v-card-text>
                </v-card>
...
export default {
    components:{ModalDelete},
     ...
     methods: {
        ...
        ...mapMutations('categorys',['addNewCategory','setEditCategory','setDeleteCategory']),
